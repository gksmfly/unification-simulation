...
def run():
    ...
    # 파일 경로
    trade_file = 'unification-simulation/data/통일부_남북교역_품목별_통계_20220531.csv'
    pre_file = 'unification-simulation/data/통일전 전체 거리 비용.xlsx'
    post_file = 'unification-simulation/data/통일후 전체 거리 비용.xlsx'
